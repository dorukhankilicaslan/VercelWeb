...
const HomePage = forwardRef<HTMLDivElement, { setPage: React.Dispatch<React.SetStateAction<string>> }>(
    ({ setPage }, ref) => {
        return (
            <div ref={ref} className="bg-[var(--background)] isolate" style={{ overflow: "hidden", height: "100%" }}>

                <div className="hidden lg:flex absolute z-0" style={{ transform: "rotate(-15deg)", width: "100vw", height: "200vh", left: "-83%", top: "-50%", backgroundColor: "var(--primary)" }}></div>
                ...
                <div className="z-1 h-dvh flex items-center justify-center">
                    ...
                    <div className="md:w-3/5 h-dvh flex items-center justify-center text-5xl md:text-3xl font-bold z-2 mainPageRightSideMain" style={{ maxWidth: "50%" }}>
                        <div className="flex flex-col text-center items-center lg:items-start lg:justify-center lg:text-left mt-10 md:mt-0">

                            <div className="hidden md:flex lg:hidden -md:hidden items-center justify-center mb-5 z-5">
                            ...
                            <h1 className="flex items-center -md:text-center md:justify-center lg:justify-start lg:items-start">
                                <ul>
                                    <li className="flex items-center">
                                        ...
                                        <span className="uppercase text-3xl leading-1 md:leading-tight md:text-5xl whitespace-nowrap" style={{ fontFamily: "Poppins", color: "var(--primary)" }}>I'm steve milner.</span>
                                    </li>
                                    <li className="mb-3 ">
