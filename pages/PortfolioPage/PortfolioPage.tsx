...
const PortfolioPage: React.FC = () => {
    ...
    return (
        <div className='relative min-h-screen bg-[var(--background)] overflow-y-auto mt-10 font-[poppins]'>
            <h1 className='isolate text-center grid place-items-center mb-10 md:mb-15'>
            ...
            {/* Projeleri JSON verisinden dinamik olarak render et */}
            {projects.map((project) => (
                <div key={project.id} className='mx-40 my-10 bg-[var(--passive)] rounded-2xl p-[1rem]'>
                    <div className='w-full max-w-7xl mx-auto'>
                        <div className="col-span-full flex flex-col justify-center text-center mb-4"> {/* Başlık ve çizgi arasına boşluk */}
                            <h2 className="text-2xl font-[Poppins] font-semibold text-[var(--foreground)]">
                                {project["firm-name"]}
                                <span className='ml-6 text-lg font-normal opacity-80'>{project["project-desc"]}</span>
                            </h2>
                        ...
                        <Gallery initialImages={project["project-images"]} />
                    </div>
                </div>
            ))}
