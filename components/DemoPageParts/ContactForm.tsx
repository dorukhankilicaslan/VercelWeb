        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="col-span-1">
                    <input
                        ...
                        className="w-full p-3 border-2 focus:border-2 outline-none
                        border-[var(--passive)] focus:border-[var(--primary)] transition-color duration-300
                        rounded-full bg-transparent text-[var(--foreground)] placeholder-[var(--passive)]"
                    />
                </div>
                <div className="col-span-1">
                    <input
            ...
            <div className="col-span-full">
                ...
                <textarea
                    ...
                    border-2 border-[var(--passive)]
                    rounded-md bg-transparent text-foreground placeholder-[var(--passive)]
                ...
                <button
                    ...
                    onClick={() => { }}
                >
                    <span className={`z-2 mr-4 ml-5 font-semibold font-[Poppins] text-[var(--foreground)]`}>
                        Mesajı Gönder
                    </span>
                    <div className={`bg-[var(--primary)] h-12 w-12 absolute right-0 flex items-center justify-end 
            ...
            <div className="col-span-full">
                {formMessage && (
                    <span className={`output_message text-center block text-uppercase font-semibold 
