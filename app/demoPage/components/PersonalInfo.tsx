...
export default function PersonalInfo() {
  return (
    <div className="flex flex-col md:justify-center md:items-center lg:items-normal lg:justify-normal">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 pb-20">
        <div className="lg:col-span-5 xl:col-span-6 md:ml-0 ">
          <div className="grid grid-cols-1 sm:grid-cols-2  md:gap-x-12 md-lg:text-center">
            <h3 className="col-span-2 mb-6 uppercase font-semibold text-2xl">
              personal info
            </h3>

            <div className="grid-cols-1 md:grid-cols-2 col-span-2 md:col-span-1  ">
              <ul>
                <li className="mb-[20px] lg:flex lg:flex-col xl:flex-row xl:items-center ">
        ...
        <div className="lg:col-span-7 xl:col-span-6 mt-10 lg:mt-0">
          <div className="grid grid-cols-2 gap-6">
            {" "}
            {/* İstatistik kutuları için grid */}
            <ExperienceBox
              number={"6 YIL"}
              text1="GRAFİK VE YAZILIM"
              text2="ALANINDA DENEYİM"
            />
            <ExperienceBox
              number={"7"}
              text1="FARKLI SEKTÖRDE"
              text2="İŞ DENEYİMİ"
            />
            <ExperienceBox
              number={"10+"}
              text1="TASARIM & YAZILIM"
              text2="ARACI BİLGİSİ"
            />
            <ExperienceBox
              number={"7/24"}
              text1="ÖĞRENMEYE AÇIK"
              text2="VE ÜRETKEN"
            />
          </div>
        </div>
