      ...
      <div className="z-1 flex items-center justify-center md:min-w-screen min-h-screen">
        ...
        >
          <div className="flex flex-col text-center items-center lg:items-start lg:justify-center lg:text-left mt-10 md:mt-0">
            ...
            <p
              className="mt-4 text-wrap break-words
              text-sm md:text-lg lg:text-lg xl:text-xl
              text-center md:text-left  lg:text-start
              font-semibold font-[Poppins]]" //max-w-70 md:min-w-120 xl:max-w-200
            >
              {`Temiz, kullanıcı odaklı ve estetik deneyimler yaratmaya
              odaklanıyorum. Çevremdekilerin hayatını kolaylaştıran, 
              fonksiyonel ve modern yazılımlar geliştirmek benim tutkum.`}
            </p>
