...
export default function Sidebar({ activeSection }: SidebarProps) {
  ...
  return (
    <aside className="w-full h-full md:mt-0 lg:pt-5 relative">
      <div className="h-full flex flex-col justify-center items-center text-center md:items-start md:text-start">
        ...
        <div className="flex flex-col gap-2">
          ...
          <span>
            <a
              ...
              className="text-[var(--foreground)]/70 hover:text-[var(--foreground)] transition-colors duration-300 text-sm lg:text-base xl:text-xl"
            >
              Özgeçmiş Görüntüle
            </a>
          </span>
        ...
        <p className="italic text-[var(--foreground)]/80 font-serif mt-6 mb-2 leading-7 text-sm lg:text-base xl:text-lg">
          ...
          <ul className="space-y-6 text-xl font-semibold text-[var(--foreground)]">
            ...
            <li>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-base text-[var(--foreground)]/70 hover:text-[var(--foreground)]"
              >
                Özgeçmiş Görüntüle
              </a>
            </li>
